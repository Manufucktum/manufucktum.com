            ...
            <div className="current-box-wrapper">
                ...
                >
                    {Object.keys(manu.currentArtist).length !== 0 && (
                        <>
                            <Link to="/live"> 
                                <h1>{manu.api.exhibits[2].title}</h1>
                                <h5>installation by {manu.currentArtist.name}</h5>
                            </Link>
                        </>
                    )}            
                </div>
                <div className="main-ref">
                    <Link 
                        ...
                        style={{ color: manu.dark }}
                    >
                        <p style={{ backgroundColor: manu.light }}>Wtf are you still doing here? Watch it now!</p>
